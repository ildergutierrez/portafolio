            ...
            <?php } else { ?>
                ...
                <div class="row" style=" border-radius: 15px; overflow: hidden;">
                    ...
                    <div class="col-sm-6" style="color: #000000; background: #E5E5E5; padding-left: 50px; padding-right: 50px;">
                        <br>
                        <form action="{{ route('login.custom') }}" method="post" class="entrada">
                            <center>
                        ...
                        <div class="row" style=" border-radius: 15px; overflow: hidden;">
                            ...
                            <div class="col-sm-6 " style="color: #000000; background: #E5E5E5; padding-left: 30px; padding-right: 50px;">
                                ...
                                <form action="php/Registros_usuarios.php" method="post" class="entrada">
                                    ...
                                    <div style="display: none; color: red; font-weight: bold;" id="mensaje">
                                        <p><i>Se detecto un intento de inyeccion MYSQL</i></p>
                                    </div>
                                    <!-- Correo -->
                                    ...
                                    <div style="padding: 0;" class="input-group mb-3 d-flex">
                                        ...
                                        <div style="display: none; color: red; font-weight: bold;" id="razon">
                                            <p><i>Debe contener minimo 8 caracteres conformados por: Numero, mayusculas, menusculas y caractere especial</i></p>
                                        </div>
                                    </div>
                                    <!-- Sede -->
